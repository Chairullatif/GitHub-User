package com.khoirullatif.consumerapp.viewmodel;
    ...
    public void setFollower(final String username) {
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    Log.d("onSuccess_follower ", "Success");
                    ...
                    Log.d("onSuccess_follower ", listItems.get(3).getName());
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                Log.d("onFailur_follower", error.getMessage());
            }
        });
    }
